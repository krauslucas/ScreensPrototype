...
public class MyTestsController implements Initializable {
    ...
    /** Elemento do tipo (Button) referindo-se ao botao (Informar nota). */
    @FXML
    private Button reportNote ;
    
    /** Elemento do tipo (Button) referindo-se ao botao (Adicionar nova avaliacao). */
    @FXML
    ...
    /** Elemento do tipo (TableView) referindo-se a tabela (Minhas Avaliacoes). */
    @FXML
